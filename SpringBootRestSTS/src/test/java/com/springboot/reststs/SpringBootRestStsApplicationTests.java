...
@SpringApplicationConfiguration(classes = SpringBootRestStsApplication.class)
@WebIntegrationTest
@ActiveProfiles("test")
public class SpringBootRestStsApplicationTests {

	 @Test
	  public void testVanillaService() {
	    RestTemplate restTemplate = new RestTemplate();
	    Greet greet = restTemplate.getForObject("http://localhost:8080", Greet.class);
	    //Assert.assertEquals("Hello from test Yaml file : Hello World!", greet.getMessage());
	  }
	 ...
	 @Test
	  public void testSecureService() {  
	    ...
	    Assert.assertEquals("external : Hello World!", response.getBody().getMessage());
	  }
	 ...
	 @Test
	  public void testOAuthService() {
	        ...
	        Assert.assertEquals("external : Hello World!", greet.getMessage());
	  }
